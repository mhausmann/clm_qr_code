...
yum -y install keyutils-libs-devel libcom_err-devel libselinux-devel libsepol-devel krb5-devel openssl-devel httpd php
echo $SEP
...
# Uncomment the next line to search for the sdk archive and copy it to the current working directory before continuing.
